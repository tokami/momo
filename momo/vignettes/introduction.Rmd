---
title: "Introduction to fine-scale movement modeling based on tagging data"
...
output:
    ...
    toc_float:
      collapsed: false
vignette: >
  %\VignetteIndexEntry{Introduction to fine-scale movement modeling based on tagging data}
