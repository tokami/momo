...
```{r, eval=TRUE, echo=FALSE, fig.alt = "Mark-recapture and archival tags"}
## Load ctags
...
```{r, eval=FALSE, echo=FALSE, fig.alt = "Spatial grid"}
...
```{r, eval=TRUE, echo=FALSE, fig.alt = "Spatial grid"}
...
```{r, eval=TRUE, echo=FALSE, fig.alt = "First four environmental fields"}
## Env data
